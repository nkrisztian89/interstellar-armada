...
define([
    ...
    function refresh(elements, shaderResource) {
        ...
        resources.executeWhenReady(function () {
            ...
            var vertexShaderTitle = document.createElement("h1");
            ...
            var vertexShaderCode = document.createElement("p");
            vertexShaderCode.classList.add("glsl-code");
            var code = _shaderResource.getVertexShaderSource();
            vertexShaderCode.innerHTML = _processCode(code);
            _codeDiv.appendChild(vertexShaderCode);
            var fragmentShaderTitle = document.createElement("h1");
            ...
            var fragmentShaderCode = document.createElement("p");
